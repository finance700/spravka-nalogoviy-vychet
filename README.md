...
| **Claude API (Anthropic SDK)** | Обработка данных анкеты, логика заполнения полей, проверка корректности |
| **PyMuPDF (fitz)** | Заполнение PDF-формы и генерация итогового документа |
| **NocoDB** | База данных для хранения анкет клиентов |
...
В папке [`Пример справки — Иванов Иван Иванович.pdf`](Пример%20справки%20—%20Иванов%20Иван%20Иванович.pdf) — готовая двухстраничная справка КНД 1151158:
